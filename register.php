            ...
            <div id="layoutAuthentication_content">
                <main>
                    <div class="container">
                        ...
                        <body style="background-image: url('assets/img/images3.jpg');"class="bg-dark">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Register Perpustakaan Digital</h3>
                                </div>
                                    <div class="card-body">
                                        <?php
                                            if(isset($_POST['register'])) {
                                                ...
                                                $insert = mysqli_query($koneksi, "INSERT INTO user(nama,email,alamat,no_telepon,username,password,level) VALUES
                                                ('$nama','$email','$alamat','$no_telepon','$username','$password','$level')");
